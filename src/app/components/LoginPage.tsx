  ...
  const features = [
    {
      icon: Calendar,
      title: "500+ Events",
      description: "Annual campus activities",
    },
    {
      icon: Users,
      title: "10K+ Students",
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="space-y-8">
            <div>
              ...
              >
                Discover, register, and manage all campus events and workshops in
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-8 lg:p-10">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-600">
                Sign in to access your university events dashboard
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3.5 rounded-xl font-semibold hover:shadow-lg hover:shadow-blue-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
                Sign In
              </button>
              ...
              <button
                type="button"
                className="w-full bg-white border-2 border-slate-300 text-slate-700 py-3.5 rounded-xl font-semibold hover:bg-slate-50 hover:border-slate-400 transition-all flex items-center justify-center gap-3"
              >
